...
Bu sinif:
- Memory kayitlarini vector olarak saklar
- Embedding islemini otomatik yapar
- Disk uzerinde kalici saklama yapar
- Semantic search destekler

Not:
Bu production icin uygundur.
InMemory versiyona gore daha profesyoneldir.
"""
...
class ChromaAgentMemory(InMemoryAgentMemory):
    """
    ...
    def __init__(
        ...
        # Diskte kalici saklama icin persist directory
        self.persist_directory = persist_directory
        self.collection_name = collection_name
        
        # Thread executor async uyumluluk icin
        self._executor = ThreadPoolExecutor(max_workers=2)

        # Chroma client ve collection
        self._client = chromadb.PersistentClient(
            path=self.persist_directory,
            settings=Settings(anonymized_telemetry=False),
        )        

         # Embedding function yoksa default kullan
    ...
    # Eger embedding verilmemisse default kullan
    ...
    async def save_tool_usage(
        ...
        def _save():
            ...
            # Complex tipleri json stringe cevir
            memory_data = {
                "question": question,
                "tool_name": tool_name,
    ...
    async def search_similar_usage(
        ...
        *,
        ...
        def _search():
            ...
            # Sadece basarili tool kullanimlarini filtrele
            if tool_name_filter:
                where_filter = {
